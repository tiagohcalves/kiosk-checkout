...
class TestValidation:
    ...
    def test_category_image_validation(self, client):
        ...
        response = client.post(
            ...
            json={"name": "Valid Category", "image": long_image},
        )
        assert response.status_code == 400
        ...
        response = client.post(
            "/api/v1/admin/categories",
            json={"name": "Valid Category 2", "image": max_image},
        )
        assert response.status_code == 200
    ...
    def test_item_name_validation(self, client, db):
        ...
        category_response = client.post(
            "/api/v1/admin/categories",
            json={"name": "Test Category 2", "image": "test.jpg"},
        )
        ...
        response = client.post(
            "/api/v1/admin/items",
            json={"name": "", "price": 10.99, "category_id": category_id},
        )
        assert response.status_code == 400
        assert "name is required" in response.json()["detail"].lower()
        ...
        response = client.post(
            "/api/v1/admin/items",
            json={"name": long_name, "price": 10.99, "category_id": category_id},
        )
        assert response.status_code == 400
        ...
        response = client.post(
            "/api/v1/admin/items",
            json={"name": max_name, "price": 10.99, "category_id": category_id},
        )
        assert response.status_code == 200
    ...
    def test_item_price_validation(self, client, db):
        ...
        category_response = client.post(
            "/api/v1/admin/categories",
            json={"name": "Test Category 3", "image": "test.jpg"},
        )
        assert category_response.status_code == 200
        category_id = category_response.json()["id"]
        ...
        response = client.post(
            "/api/v1/admin/items",
            json={"name": "Zero Price Item", "price": 0.0, "category_id": category_id},
        )
        ...
        response = client.post(
            "/api/v1/admin/items",
            json={"name": "Cheap Item", "price": 0.01, "category_id": category_id},
        )
        assert response.status_code == 200
    ...
    def test_item_category_validation(self, client, db):
        ...
        response = client.post(
            "/api/v1/admin/items",
            json={"name": "Test Item", "price": 10.99, "category_id": 99999},
        )
        assert response.status_code == 400
    ...
    def test_item_duplicate_validation(self, client, db):
        ...
        category_response = client.post(
            "/api/v1/admin/categories",
            json={"name": "Test Category 4", "image": "test.jpg"},
        )
        assert category_response.status_code == 200
        category_id = category_response.json()["id"]
        ...
        category2_response = client.post(
            "/api/v1/admin/categories",
            json={"name": "Another Category", "image": "test2.jpg"},
        )
        ...
        item_response = client.post(
            "/api/v1/admin/items",
            json={"name": "Test Item", "price": 10.99, "category_id": category_id},
        )
        ...
        different_category_response = client.post(
            "/api/v1/admin/items",
            json={
