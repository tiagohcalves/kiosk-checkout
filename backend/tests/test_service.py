    ...
    def sample_items(self):
        ...
        return [
            ...
            models.Item(
                ...
                name="Cheese Burger",
                price=14.99,
                image_id="burger2.jpg",
                category_id=1,
            ),
            models.Item(
                id=3, name="Coke", price=2.99, image_id="coke.jpg", category_id=2
            ),
        ]
...
class TestOrderService:
    ...
    def sample_items(self):
        ...
        return {
            1: models.Item(
                id=1, name="Burger", price=10.99, image_id="burger.jpg", category_id=1
            ),
            2: models.Item(
                id=2, name="Fries", price=4.99, image_id="fries.jpg", category_id=1
            ),
        }
    ...
    def test_create_order_total_calculation_edge_cases(self, order_service):
        ...
        sample_items = {
            1: models.Item(
                id=1, name="Item1", price=0.01, image_id="item1.jpg", category_id=1
            ),
            2: models.Item(
                id=2, name="Item2", price=999.99, image_id="item2.jpg", category_id=1
            ),
        }
...
class TestAdminService:
    ...
    def test_create_category_duplicate_name(
        ...
        category_data = schemas.CategoryCreate(
            name="Existing Category", image="test.jpg"
        )
    ...
    def test_create_item_success(
        ...
        item_data = schemas.ItemCreate(
            name="New Item", price=12.99, image_id="item.jpg", category_id=1
        )
    ...
    def test_create_item_duplicate_name_in_category(
        ...
        mock_get_categories.return_value = [models.Category(id=1, name="Test Category")]
        existing_item = models.Item(
            id=1, name="Existing Item", price=10.99, category_id=1
        )
    ...
    def test_create_item_image_id_too_long(
        ...
        item_data = schemas.ItemCreate(
            name="Valid Item", price=12.99, image_id=long_image_id, category_id=1
        )
